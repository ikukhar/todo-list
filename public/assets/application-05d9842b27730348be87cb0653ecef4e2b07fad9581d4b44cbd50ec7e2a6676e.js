...
(function() {
  var button, div, form, i, input, ref, span;

  ref = React.DOM, i = ref.i, div = ref.div, span = ref.span, button = ref.button, form = ref.form, input = ref.input;
    ...
    handleDelete: function(e) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function() {
            return _this.props.handleDeleteProject(_this.props.project);
          };
        })(this)
      });
    },
...
(function() {
  ...
  ref = React.DOM, div = ref.div, span = ref.span, button = ref.button, i = ref.i, input = ref.input, form = ref.form;
    ...
    handleSubmit: function(e) {
      ...
      return $.post('/projects/', {
        ...
        return function(data) {
          _this.props.handleNewProject(data);
...
(function() {
  var a, div, form, h5, i, input, label, li, ref, ul;

  ref = React.DOM, a = ref.a, i = ref.i, div = ref.div, ul = ref.ul, li = ref.li, input = ref.input, form = ref.form, h5 = ref.h5, label = ref.label;

  this.Task = React.createClass({
    getInitialState: function() {
      return {
    ...
    handleChangeStatus: function(e) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function() {
            return _this.changeStatus(!_this.state.status);
          };
        })(this)
      });
    },
    render: function() {
      ...
      return div({
        ...
        name: this.props.task.name,
        checked: (ref1 = this.state.status) != null ? ref1 : {
          'checked': ''
        }
      }), h5(null, this.props.task.name), a({
...
(function() {
  var button, div, form, h2, i, input, li, ref, ul;

  ref = React.DOM, button = ref.button, i = ref.i, div = ref.div, ul = ref.ul, li = ref.li, input = ref.input, form = ref.form, h2 = ref.h2;

  this.TaskForm = React.createClass({
    getInitialState: function() {
      return {
        name: '',
        status: false,
    ...
    handleSubmit: function(e) {
      ...
      return $.post('/tasks/', {
        ...
        return function(data) {
          _this.props.handleNewTask(data);
          return _this.setState(_this.getInitialState());
        };
      })(this), 'JSON');
    },
...
(function() {
  var button, div, form, h4, i, input, li, ref, ul;

  ref = React.DOM, button = ref.button, i = ref.i, div = ref.div, ul = ref.ul, li = ref.li, input = ref.input, form = ref.form, h4 = ref.h4;

  this.Tasks = React.createClass({
    getInitialState: function() {
      return {
    ...
    render: function() {
      ...
      return div({
        ...
        className: 'title'
      }, 'Tasks'), React.createElement(TaskForm, {
        ...
        ref1 = this.state.tasks;
        results = [];
        for (j = 0, len = ref1.length; j < len; j++) {
          task = ref1[j];
          results.push(React.createElement(Task, {
            key: task.id,
            task: task,
            project: this.props.project,
...
(function() {
  var a, div, h1, h4, hr, p, ref;

  ref = React.DOM, div = ref.div, h1 = ref.h1, h4 = ref.h4, hr = ref.hr, p = ref.p, a = ref.a;
  ...
  this.TodoList = React.createClass({
    render: function() {
      return div({
        ...
        className: 'lead'
      }, 'React + Bootstrap')), React.createElement(Projects, {
